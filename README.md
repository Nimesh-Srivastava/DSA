...
![Problems](https://img.shields.io/badge/Problems-65-brown.svg?style=for-the-badge)&nbsp;&nbsp;
...
| ID | Title | Solution | Time | Space | Difficulty | Tags | Note | 
|----|-------|----------|------|-------|------------|------|------|
| 1614 | [Maximum nesting depth of the parantheses](https://leetcode.com/problems/maximum-nesting-depth-of-the-parentheses) | [C++](./C++/000.cpp) |||🟢|||
